        ...
        >
          <label className='flex flex-col'>
            ...
            <input
              ...
              className='bg-tertiary py-4 px-6 placeholder:text-secondary text-ptext rounded-lg outline-none border-none font-medium'
            />
          </label>
          <label className='flex flex-col'>
          ...
          <button
            type='submit'
            className='bg-tertiary py-3 px-8 rounded-xl outline-none w-fit text-ptext font-bold shadow-md shadow-primary'
          >
